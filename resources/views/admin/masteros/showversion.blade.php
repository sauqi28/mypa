      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="">Nama OS</a></li>
            <li class="breadcrumb-item">Versi OS</li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div class="d-flex flex-row-reverse">
            <div class="page_action">
              <a href="{{route('masteros.createosname', $idos)}}"><button type="button" class="btn btn-primary">Tambah</button></a>
      ...
      <div class="col-lg-12 col-md-12">
        ...
        <div class="body table-responsive social_media_table">
          <table class="table table-hover">
            ...
            <tbody>
              @forelse ($version as $version)
              <tr>
                <td><span class="social_icon linkedin"><i class="fa fa-linkedin"></i></span>
                </td>
                <td><span class="list-name">{{ $version->version }}</span>
